...
public final class BouncyCastleProvider extends Provider {
   ...
   public BouncyCastleProvider() {
      ...
      this.put("Cipher." + NISTObjectIdentifiers.id_aes128_ECB, "org.bouncycastle.jce.provider.JCEBlockCipher$AES");
      this.put("Cipher." + NISTObjectIdentifiers.id_aes192_ECB, "org.bouncycastle.jce.provider.JCEBlockCipher$AES");
      this.put("Cipher." + NISTObjectIdentifiers.id_aes256_ECB, "org.bouncycastle.jce.provider.JCEBlockCipher$AES");
      this.put("Cipher." + NISTObjectIdentifiers.id_aes128_CBC, "org.bouncycastle.jce.provider.JCEBlockCipher$AESCBC");
      this.put("Cipher." + NISTObjectIdentifiers.id_aes192_CBC, "org.bouncycastle.jce.provider.JCEBlockCipher$AESCBC");
      this.put("Cipher." + NISTObjectIdentifiers.id_aes256_CBC, "org.bouncycastle.jce.provider.JCEBlockCipher$AESCBC");
      this.put("Cipher." + NISTObjectIdentifiers.id_aes128_OFB, "org.bouncycastle.jce.provider.JCEBlockCipher$AESOFB");
      this.put("Cipher." + NISTObjectIdentifiers.id_aes192_OFB, "org.bouncycastle.jce.provider.JCEBlockCipher$AESOFB");
      this.put("Cipher." + NISTObjectIdentifiers.id_aes256_OFB, "org.bouncycastle.jce.provider.JCEBlockCipher$AESOFB");
      this.put("Cipher." + NISTObjectIdentifiers.id_aes128_CFB, "org.bouncycastle.jce.provider.JCEBlockCipher$AESCFB");
      this.put("Cipher." + NISTObjectIdentifiers.id_aes192_CFB, "org.bouncycastle.jce.provider.JCEBlockCipher$AESCFB");
      this.put("Cipher." + NISTObjectIdentifiers.id_aes256_CFB, "org.bouncycastle.jce.provider.JCEBlockCipher$AESCFB");
      ...
      this.put("Cipher.CAMELLIA", "org.bouncycastle.jce.provider.JCEBlockCipher$Camellia");
      ...
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes128_ECB, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES128");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes128_CBC, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES128");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes128_OFB, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES128");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes128_CFB, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES128");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes192_ECB, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES192");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes192_CBC, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES192");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes192_OFB, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES192");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes192_CFB, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES192");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes256_ECB, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES256");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes256_CBC, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES256");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes256_OFB, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES256");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes256_CFB, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES256");
      this.put("KeyGenerator.AESWRAP", "org.bouncycastle.jce.provider.JCEKeyGenerator$AES");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes128_wrap, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES128");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes192_wrap, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES192");
      this.put("KeyGenerator." + NISTObjectIdentifiers.id_aes256_wrap, "org.bouncycastle.jce.provider.JCEKeyGenerator$AES256");
      this.put("KeyGenerator.SERPENT", "org.bouncycastle.jce.provider.JCEKeyGenerator$Serpent");
      this.put("KeyGenerator.CAMELLIA", "org.bouncycastle.jce.provider.JCEKeyGenerator$Camellia");
      ...
      this.put("Alg.Alias.KeyGenerator.HMAC-MD2", "HMACMD2");
      this.put("KeyGenerator.HMACMD4", "org.bouncycastle.jce.provider.JCEKeyGenerator$MD4HMAC");
      this.put("Alg.Alias.KeyGenerator.HMAC-MD4", "HMACMD4");
      ...
      this.put("Alg.Alias.KeyGenerator.HMAC-RIPEMD128", "HMACRIPEMD128");
      this.put("KeyGenerator.HMACRIPEMD160", "org.bouncycastle.jce.provider.JCEKeyGenerator$RIPEMD160HMAC");
      this.put("Alg.Alias.KeyGenerator.HMAC-RIPEMD160", "HMACRIPEMD160");
      ...
      this.put("Alg.Alias.KeyGenerator." + PKCSObjectIdentifiers.id_hmacWithSHA1, "HMACSHA1");
      this.put("KeyGenerator.HMACSHA224", "org.bouncycastle.jce.provider.JCEKeyGenerator$HMACSHA224");
      this.put("Alg.Alias.KeyGenerator.HMAC-SHA224", "HMACSHA224");
      this.put("Alg.Alias.KeyGenerator." + PKCSObjectIdentifiers.id_hmacWithSHA224, "HMACSHA224");
      this.put("KeyGenerator.HMACSHA256", "org.bouncycastle.jce.provider.JCEKeyGenerator$HMACSHA256");
      this.put("Alg.Alias.KeyGenerator.HMAC-SHA256", "HMACSHA256");
      this.put("Alg.Alias.KeyGenerator." + PKCSObjectIdentifiers.id_hmacWithSHA256, "HMACSHA256");
      this.put("KeyGenerator.HMACSHA384", "org.bouncycastle.jce.provider.JCEKeyGenerator$HMACSHA384");
      this.put("Alg.Alias.KeyGenerator.HMAC-SHA384", "HMACSHA384");
      this.put("Alg.Alias.KeyGenerator." + PKCSObjectIdentifiers.id_hmacWithSHA384, "HMACSHA384");
      this.put("KeyGenerator.HMACSHA512", "org.bouncycastle.jce.provider.JCEKeyGenerator$HMACSHA512");
      this.put("Alg.Alias.KeyGenerator.HMAC-SHA512", "HMACSHA512");
      this.put("Alg.Alias.KeyGenerator." + PKCSObjectIdentifiers.id_hmacWithSHA512, "HMACSHA512");
      ...
      this.put("KeyPairGenerator.EC", "org.bouncycastle.jce.provider.JDKKeyPairGenerator$EC");
      ...
      this.put("KeyPairGenerator.ECGOST3410", "org.bouncycastle.jce.provider.JDKKeyPairGenerator$ECGOST3410");
      ...
      this.put("KeyFactory.ECGOST3410", "org.bouncycastle.jce.provider.JDKKeyFactory$ECGOST3410");
      ...
      this.put("SecretKeyFactory.PBEWITHSHAANDIDEA-CBC", "org.bouncycastle.jce.provider.JCESecretKeyFactory$PBEWithSHAAndIDEA");
   ...
   private void addMacAlgorithms() {
      ...
      this.put("Mac.DESWITHISO9797", "org.bouncycastle.jce.provider.JCEMac$ISO9797_DES");
      ...
      this.put("Alg.Alias.Mac.HMAC/SHA1", "HMACSHA1");
      this.put("Alg.Alias.Mac." + PKCSObjectIdentifiers.id_hmacWithSHA1, "HMACSHA1");
      this.put("Mac.HMACSHA224", "org.bouncycastle.jce.provider.JCEMac$SHA224");
      this.put("Alg.Alias.Mac.HMAC-SHA224", "HMACSHA224");
      this.put("Alg.Alias.Mac.HMAC/SHA224", "HMACSHA224");
      this.put("Alg.Alias.Mac." + PKCSObjectIdentifiers.id_hmacWithSHA224, "HMACSHA224");
      this.put("Mac.HMACSHA256", "org.bouncycastle.jce.provider.JCEMac$SHA256");
      this.put("Alg.Alias.Mac.HMAC-SHA256", "HMACSHA256");
      this.put("Alg.Alias.Mac.HMAC/SHA256", "HMACSHA256");
      this.put("Alg.Alias.Mac." + PKCSObjectIdentifiers.id_hmacWithSHA256, "HMACSHA256");
      ...
      this.put("Alg.Alias.Mac.HMAC/SHA384", "HMACSHA384");
      this.put("Alg.Alias.Mac." + PKCSObjectIdentifiers.id_hmacWithSHA384, "HMACSHA384");
      this.put("Mac.HMACSHA512", "org.bouncycastle.jce.provider.JCEMac$SHA512");
      this.put("Alg.Alias.Mac.HMAC-SHA512", "HMACSHA512");
      this.put("Alg.Alias.Mac.HMAC/SHA512", "HMACSHA512");
      this.put("Alg.Alias.Mac." + PKCSObjectIdentifiers.id_hmacWithSHA512, "HMACSHA512");
   ...
   private void addSignatureAlgorithms() {
      ...
      this.put("Signature.SHA224WITHECDSA", "org.bouncycastle.jce.provider.JDKDSASigner$ecDSA224");
      this.put("Signature.SHA256WITHECDSA", "org.bouncycastle.jce.provider.JDKDSASigner$ecDSA256");
      this.put("Signature.SHA384WITHECDSA", "org.bouncycastle.jce.provider.JDKDSASigner$ecDSA384");
      this.put("Signature.SHA512WITHECDSA", "org.bouncycastle.jce.provider.JDKDSASigner$ecDSA512");
      this.put("Signature.SHA1WITHECNR", "org.bouncycastle.jce.provider.JDKDSASigner$ecNR");
      this.put("Signature.SHA224WITHECNR", "org.bouncycastle.jce.provider.JDKDSASigner$ecNR224");
      this.put("Signature.SHA256WITHECNR", "org.bouncycastle.jce.provider.JDKDSASigner$ecNR256");
      this.put("Signature.SHA384WITHECNR", "org.bouncycastle.jce.provider.JDKDSASigner$ecNR384");
      this.put("Signature.SHA512WITHECNR", "org.bouncycastle.jce.provider.JDKDSASigner$ecNR512");

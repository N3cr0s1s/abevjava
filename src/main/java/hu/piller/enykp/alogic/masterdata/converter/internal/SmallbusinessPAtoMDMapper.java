...
public class SmallbusinessPAtoMDMapper extends PAtoMDMapper {
   public String getEntityType() {
      return "Egyéni vállalkozó";
   }

   protected void buildMappings() {
      this.mappings.put("first_name", new PAtoMDMapper.Mapping("Törzsadatok", "Vezetékneve"));
      this.mappings.put("last_name", new PAtoMDMapper.Mapping("Törzsadatok", "Keresztneve"));
      this.mappings.put("tax_id", new PAtoMDMapper.Mapping("Törzsadatok", "Adózó adóazonosító jele"));
      ...
      this.mappings.put("name", new PAtoMDMapper.Mapping("N/A", "N/A"));
   }
}

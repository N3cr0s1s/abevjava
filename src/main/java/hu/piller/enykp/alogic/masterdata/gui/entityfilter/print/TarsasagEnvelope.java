...
public class TarsasagEnvelope extends ABEVEnvelope {
   private Entity entity;

   public TarsasagEnvelope(Entity var1) {
      this.entity = var1;
   }
   ...
   protected Hashtable getData(int var1) {
      ...
      if (this.record != null) {
         var2.put("f_feladó", this.entity.getBlock("Törzsadatok").getMasterData("Adózó neve").getValue());

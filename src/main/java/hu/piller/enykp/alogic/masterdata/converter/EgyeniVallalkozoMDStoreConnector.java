...
public class EgyeniVallalkozoMDStoreConnector implements MDStoreConnector {
   public Entity getEntity(String var1) throws EntityException {
      Entity var2 = null;
      Entity[] var4 = (new EntityHome()).findByTypeAndMasterData("Egyéni vállalkozó", new MasterData[]{new MasterData("Adózó adószáma", var1)});
      Entity[] var5 = (new EntityHome()).findByTypeAndMasterData("Egyéni vállakozó", new MasterData[]{new MasterData("Adózó adóazonosító jele", var1)});
      if (var4.length == 1 && var5.length == 1 && var4[0].getId() == var5[0].getId()) {
         var2 = var4[0];
      } else if (var4.length != 1 && var5.length == 1) {
         var2 = var5[0];
      } else if (var4.length == 1 && var5.length != 1) {
         var2 = var4[0];
      } else {
         var2 = (new EntityHome()).create("Egyéni vállalkozó");
      }
   ...
   public String[] map(String var1, boolean var2) {
      ...
      if (!var2) {
         ...
         } else if ("adoazonosito".equals(var1)) {
            var3[0] = "Törzsadatok";

...
public class CsatolmanyInfo {
   ...
   public CsatolmanyInfo(Hashtable var1) {
      this.id = (String)var1.get("id");
      String var2 = (String)var1.get("file_extensions");
      this.exts = var2;
      this.filter = new CsatolmanyInfo.CSFileFileter(var2);
      if (var2.equals("*")) {
      ...
      public boolean accept(File var1) {
         if (var1.isDirectory()) {
            ...
            if (var1.isFile()) {
               ...
               if (this.extensions.toLowerCase().indexOf(var2.toLowerCase()) > -1) {
                  return true;
               }
            }

...
public class DirChooserPanel2 extends JPanel {
   ...
   public DirChooserPanel2() {
      ...
      var5.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent var1) {
            TreePath var2 = DirChooserPanel2.this.tree.getSelectionPath();
            if (var2 != null) {
      ...
      var6.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent var1) {
            ...
            if (var2 != null) {
               ...
               if (var6) {
                  DirChooserPanel2.this.setRootdir(DirChooserPanel2.this.rootdir, (File)null);
               }
         ...
         public void keyPressed(KeyEvent var1) {
            ...
            if (var1.getKeyCode() == 40) {
               if (var1.getModifiers() == 1) {
                  DirChooserPanel2.this.found_pos++;
                  if (DirChooserPanel2.this.found_pos >= DirChooserPanel2.this.found.size()) {
                     DirChooserPanel2.this.found_pos = 0;
                  }

                  var7 = (DefaultMutableTreeNode)DirChooserPanel2.this.found.get(DirChooserPanel2.this.found_pos);
                  DirChooserPanel2.this.visibleNode(var7);
                  return;
               }

               var2 = DirChooserPanel2.this.tree.getSelectionRows();
               if (var2 == null) {
                  return;
               }

               var3 = var2[0] + 1;
               DirChooserPanel2.this.tree.setSelectionRow(var3);
               var4 = DirChooserPanel2.this.tree.getSelectionPath();
               DirChooserPanel2.this.tree.scrollPathToVisible(var4);
            }
            ...
            if (var1.getKeyCode() == 39) {
               var2 = DirChooserPanel2.this.tree.getSelectionRows();
               DirChooserPanel2.this.tree.expandRow(var2[0]);
               var3 = var2[0] + 1;
               DirChooserPanel2.this.tree.setSelectionRow(var3);
               var4 = DirChooserPanel2.this.tree.getSelectionPath();
               DirChooserPanel2.this.tree.scrollPathToVisible(var4);
            ...
            if (var1.getKeyCode() == 36) {
               ...
               var6 = DirChooserPanel2.this.tree.getSelectionPath();
               DirChooserPanel2.this.tree.scrollPathToVisible(var6);
               var1.consume();
            }
            ...
            if (var1.getKeyCode() == 10) {
               ...
               DefaultMutableTreeNode var8 = (DefaultMutableTreeNode)var6.getLastPathComponent();
               DirChooserPanel2.Entity var9 = (DirChooserPanel2.Entity)var8.getUserObject();
               DefaultTreeModel var5 = DirChooserPanel2.this.getDirModel(var9.f);
               DirChooserPanel2.this.tree.setModel(var5);
            }
   ...
   public void setRootdir(File var1, final File var2) {
      ...
      Thread var5 = new Thread(new Runnable() {
         public void run() {
            DefaultTreeModel var1 = DirChooserPanel2.this.getDirModel((File)null);
            DirChooserPanel2.this.tree.setModel(var1);
            if (var2 != null) {
               DefaultMutableTreeNode var2x = DirChooserPanel2.this.getFromList(var2);
               if (var2x != null) {
                  DirChooserPanel2.this.visibleNode(var2x);
               }
            }
   ...
   public DefaultTreeModel getDirModel(File var1) {
      ...
      if (var1.isDirectory()) {
         DefaultMutableTreeNode var2 = new DefaultMutableTreeNode(new DirChooserPanel2.Entity(var1));
   ...
   public void fillsubdirmodel(File var1, DefaultMutableTreeNode var2) {
      ...
      if (!this.rootdir.equals(var1)) {
         DefaultMutableTreeNode var4 = new DefaultMutableTreeNode(new DirChooserPanel2.Entity(var1.getParentFile(), ".."));
         var2.add(var4);
         this.list.add(var4);
      }
   ...
   private DefaultMutableTreeNode getFromList(File var1) {
      for(int var2 = 0; var2 < this.list.size(); ++var2) {
         DefaultMutableTreeNode var3 = (DefaultMutableTreeNode)this.list.get(var2);
         if (((DirChooserPanel2.Entity)var3.getUserObject()).f.equals(var1)) {
            return var3;
         }
      }
   ...
   public File getSelectedDir() {
      try {
         ...
         DirChooserPanel2.Entity var3 = (DirChooserPanel2.Entity)var2.getUserObject();
         File var4 = var3.f;
         return var4;

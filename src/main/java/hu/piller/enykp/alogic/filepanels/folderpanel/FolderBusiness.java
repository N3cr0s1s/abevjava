...
public class FolderBusiness implements IEventSupport {
   ...
   public static final int FOLDER_TASK_SLIDER = 0;
   public static final int FOLDER_TASK_FIX = 1;
   public int prev_task = -1;
   ...
   private File getDrive(File var1) {
      File var2;
      File var3;
      for(var2 = var1; !this.file_system_view.isDrive(var2); var2 = var3) {
         var3 = this.file_system_view.getParentDirectory(var2);
         if (var3 == null || var3.toString().trim().length() == 0) {
            break;
         }
      }
   ...
   public void setTask(int var1) {
      ...
      case 0:
         if (this.prev_task != 0) {
            ...
            this.lbl_splitter.setVisible(true);
            var2 = true;
         }
         break;
      case 1:
         if (this.prev_task != 1) {
            this.lbl_splitter.setVisible(false);
            this.setFolderVisibility(true);
            var2 = true;
         }
      }
      ...
      if (var2) {
         this.folder_panel.invalidate();
         this.folder_panel.repaint();
      }

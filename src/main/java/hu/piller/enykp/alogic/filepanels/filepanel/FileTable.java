...
public class FileTable extends JTable implements KeyListener {
   ...
   public FileTable() {
      if (GuiUtil.modGui()) {
         this.setRowHeight(GuiUtil.getCommonItemHeight() + 2);
      }

   }

   public TableCellRenderer getCellRenderer(int var1, int var2) {
      return (TableCellRenderer)("Verzióváltás oka".equals((String)this.getColumnModel().getColumn(var2).getHeaderValue()) ? new VersionDescCellRenderer() : super.getCellRenderer(var1, var2));
   }

   public TableCellEditor getCellEditor(int var1, int var2) {
      return (TableCellEditor)("Verzióváltás oka".equals((String)this.getColumnModel().getColumn(var2).getHeaderValue()) ? new VersionDescCellEditor() : super.getCellEditor(var1, var2));
   }
   ...
   public void keyPressed(KeyEvent var1) {
      if (var1.getModifiersEx() == 128 && var1.getKeyCode() == 65) {
         this.file_business.selectAllKeyOnFiles();
      }

   }

   public void keyReleased(KeyEvent var1) {
      if (var1.getKeyCode() == 38 || var1.getKeyCode() == 40 || var1.getKeyCode() == 33 || var1.getKeyCode() == 34) {
         this.file_business.fireSingleClickOnFiles();
      }
   ...
   public Object getValueAt(int var1, int var2) {
      ...
      if (var2 == 13) {
         ...
         try {
            var3 = OrgInfo.getInstance().getOrgShortnameByOrgID(var4);

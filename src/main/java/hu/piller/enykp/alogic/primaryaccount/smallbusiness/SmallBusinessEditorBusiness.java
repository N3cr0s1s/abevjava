...
public class SmallBusinessEditorBusiness {
   ...
   public SmallBusinessEditorBusiness(SmallBusinessEditorPanel var1) {
      this.editor_panel = var1;
      this.prepare();
   }

   private void prepare() {
      this.btn_ok = (JButton)this.editor_panel.getEPComponent("ok");
      this.btn_cancel = (JButton)this.editor_panel.getEPComponent("cancel");
      this.txt_first_name = (JTextField)this.editor_panel.getEPComponent("first_name");
      this.txt_last_name = (JTextField)this.editor_panel.getEPComponent("last_name");
      this.txt_tax_num = (JFormattedTextField)this.editor_panel.getEPComponent("tax_number");
      this.txt_tax_id = (JFormattedTextField)this.editor_panel.getEPComponent("tax_id");
      this.txt_s_settlement = (JTextField)this.editor_panel.getEPComponent("s_settlement");
      this.txt_s_public_place = (JTextField)this.editor_panel.getEPComponent("s_public_place");
      this.efc_s_public_place_type = (ENYKFilterComboPanel)this.editor_panel.getEPComponent("s_public_place_type_2");
      this.txt_s_house_number = (JTextField)this.editor_panel.getEPComponent("s_house_number");
      this.txt_s_building = (JTextField)this.editor_panel.getEPComponent("s_building");
      this.txt_s_staircase = (JTextField)this.editor_panel.getEPComponent("s_staircase");
      this.txt_s_level = (JTextField)this.editor_panel.getEPComponent("s_level");
      this.txt_s_door = (JTextField)this.editor_panel.getEPComponent("s_door");
      this.txt_s_zip = (JFormattedTextField)this.editor_panel.getEPComponent("s_zip");
      this.txt_m_settlement = (JTextField)this.editor_panel.getEPComponent("m_settlement");
      this.txt_m_public_place = (JTextField)this.editor_panel.getEPComponent("m_public_place");
      this.efc_m_public_place_type = (ENYKFilterComboPanel)this.editor_panel.getEPComponent("m_public_place_type_2");
      this.txt_m_house_number = (JTextField)this.editor_panel.getEPComponent("m_house_number");
      this.txt_m_building = (JTextField)this.editor_panel.getEPComponent("m_building");
      this.txt_m_staircase = (JTextField)this.editor_panel.getEPComponent("m_staircase");
      this.txt_m_level = (JTextField)this.editor_panel.getEPComponent("m_level");
      this.txt_m_door = (JTextField)this.editor_panel.getEPComponent("m_door");
      this.txt_m_zip = (JFormattedTextField)this.editor_panel.getEPComponent("m_zip");
      this.txt_admin = (JTextField)this.editor_panel.getEPComponent("administrator");
      this.txt_tel = (JTextField)this.editor_panel.getEPComponent("tel");
      this.txt_f_corp = (JTextField)this.editor_panel.getEPComponent("financial_corp");
      this.txt_acc_num = (JFormattedTextField)this.editor_panel.getEPComponent("account_number");
      this.prepareOk();
      this.prepareCancel();
   ...
   private void prepareFormats() {
      this.setFormatter(this.txt_tax_num, "########-#-##");
      ...
      this.txt_tax_num.addFocusListener(new FocusListener() {
      ...
      this.btn_ok.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent var1) {
            if (SmallBusinessEditorBusiness.this.isContentValid()) {
               ...
               SmallBusinessBusiness var2 = (SmallBusinessBusiness)SmallBusinessEditorBusiness.this.parent_business;
               var2.mapRecord(SmallBusinessEditorBusiness.this.record);
               var2.refreshView();
               var2.restorePanel();
   ...
   private boolean isContentValid() {
      ...
      String var2 = this.filterForNumbers(this.txt_tax_num.getText());
      String var3 = this.filterForNumbers(this.txt_tax_id.getText());
      var1 = var1.trim();
      var2 = var2.trim();
      var3 = var3.trim();
      if (var1.length() != 0 && var2.length() != 0 && var3.length() != 0) {
         if (!this.isValidTaxNumber()) {
            ...
            return false;
         } else if (!this.isValidTaxId()) {
            GuiUtil.showMessageDialog(this.editor_panel, "Az adóazonosító jel hibás !", "Törzsadat ellenőrzés", 2);
            return false;
         } else {
            IRecord[] var4;
            IRecord var5;
            if ((var4 = this.record.filterOnAll("tax_number", this.filterForNumbers(this.txt_tax_num.getText()))).length > 0) {
               var5 = this.getFirstDifferent(var4, this.record);
               if (var5 != null) {
                  GuiUtil.showMessageDialog(this.editor_panel, "Adószám már használva van itt: '" + var5 + "' !", "Törzsadat ellenőrzés", 2);
                  return false;
               }
            }

            if ((var4 = this.record.filterOnAll("tax_id", this.filterForNumbers(this.txt_tax_id.getText()))).length > 0) {
               var5 = this.getFirstDifferent(var4, this.record);
               if (var5 != null) {
                  GuiUtil.showMessageDialog(this.editor_panel, "Adóazonosító jel már használva itt: '" + var5 + "' !", "Törzsadat ellenőrzés", 2);
                  return false;
               }
            }
   ...
   private boolean isValidTaxNumber() {
      ...
      String var2 = this.txt_tax_num.getText();
   ...
   private void installKeyBindingForButton(final JButton var1, int var2) {
      ...
      SmallBusinessEditorPanel var4 = this.editor_panel;
   ...
   private void showRecord() {
      if (this.record != null) {
         ...
         this.txt_tax_num.setText((String)var1.get("tax_number"));
   ...
   private void modifyRecord() {
      if (this.record != null) {
         ...
         var1.put("tax_number", this.filterForNumbers(this.txt_tax_num.getText()));

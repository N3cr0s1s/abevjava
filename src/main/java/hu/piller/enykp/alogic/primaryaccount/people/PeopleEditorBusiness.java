...
public class PeopleEditorBusiness {
   private PeopleEditorPanel p_editor_panel;
   ...
   public PeopleEditorBusiness(PeopleEditorPanel var1) {
      this.p_editor_panel = var1;
      this.prepare();
   }

   private void prepare() {
      this.btn_ok = (JButton)this.p_editor_panel.getEPComponent("ok");
      this.btn_cancel = (JButton)this.p_editor_panel.getEPComponent("cancel");
      this.txt_first_name = (JTextField)this.p_editor_panel.getEPComponent("first_name");
      this.txt_last_name = (JTextField)this.p_editor_panel.getEPComponent("last_name");
      this.txt_tax_id = (JFormattedTextField)this.p_editor_panel.getEPComponent("tax_id");
      this.txt_s_settlement = (JTextField)this.p_editor_panel.getEPComponent("s_settlement");
      this.txt_s_public_place = (JTextField)this.p_editor_panel.getEPComponent("s_public_place");
      this.efc_s_public_place_type = (ENYKFilterComboPanel)this.p_editor_panel.getEPComponent("s_public_place_type_2");
      this.txt_s_house_number = (JTextField)this.p_editor_panel.getEPComponent("s_house_number");
      this.txt_s_building = (JTextField)this.p_editor_panel.getEPComponent("s_building");
      this.txt_s_staircase = (JTextField)this.p_editor_panel.getEPComponent("s_staircase");
      this.txt_s_level = (JTextField)this.p_editor_panel.getEPComponent("s_level");
      this.txt_s_door = (JTextField)this.p_editor_panel.getEPComponent("s_door");
      this.txt_s_zip = (JFormattedTextField)this.p_editor_panel.getEPComponent("s_zip");
      this.txt_m_settlement = (JTextField)this.p_editor_panel.getEPComponent("m_settlement");
      this.txt_m_public_place = (JTextField)this.p_editor_panel.getEPComponent("m_public_place");
      this.efc_m_public_place_type = (ENYKFilterComboPanel)this.p_editor_panel.getEPComponent("m_public_place_type_2");
      this.txt_m_house_number = (JTextField)this.p_editor_panel.getEPComponent("m_house_number");
      this.txt_m_building = (JTextField)this.p_editor_panel.getEPComponent("m_building");
      this.txt_m_staircase = (JTextField)this.p_editor_panel.getEPComponent("m_staircase");
      this.txt_m_level = (JTextField)this.p_editor_panel.getEPComponent("m_level");
      this.txt_m_door = (JTextField)this.p_editor_panel.getEPComponent("m_door");
      this.txt_m_zip = (JFormattedTextField)this.p_editor_panel.getEPComponent("m_zip");
      this.txt_admin = (JTextField)this.p_editor_panel.getEPComponent("administrator");
      this.txt_tel = (JTextField)this.p_editor_panel.getEPComponent("tel");
      this.txt_f_corp = (JTextField)this.p_editor_panel.getEPComponent("financial_corp");
      this.txt_acc_num = (JFormattedTextField)this.p_editor_panel.getEPComponent("account_number");
      this.prepareOk();
      this.prepareCancel();
   ...
   private void prepareFormats() {
      this.setFormatter(this.txt_tax_id, "##########");
      this.setFormatter(this.txt_s_zip, "AAAAAAA");
      this.setFormatter(this.txt_m_zip, "AAAAAAA");
      this.setFormatter(this.txt_acc_num, "########-########-########");
      this.txt_tax_id.addFocusListener(new FocusListener() {
         public void focusGained(FocusEvent var1) {
            PeopleEditorBusiness.this.txt_tax_id.getCaret().setDot(0);
         }
      ...
      this.txt_s_zip.addFocusListener(new FocusListener() {
         public void focusGained(FocusEvent var1) {
            PeopleEditorBusiness.this.txt_s_zip.getCaret().setDot(0);
         }
      ...
      this.txt_m_zip.addFocusListener(new FocusListener() {
         public void focusGained(FocusEvent var1) {
            PeopleEditorBusiness.this.txt_m_zip.getCaret().setDot(0);
         }
      ...
      this.txt_acc_num.addFocusListener(new FocusListener() {
         public void focusGained(FocusEvent var1) {
            PeopleEditorBusiness.this.txt_acc_num.getCaret().setDot(0);
         }
   ...
   private void prepareOk() {
      this.btn_ok.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent var1) {
            if (PeopleEditorBusiness.this.isContentValid()) {
               PeopleEditorBusiness.this.modifyRecord();
               PeopleEditorBusiness.this.record.save();
               PeopleBusiness var2 = (PeopleBusiness)PeopleEditorBusiness.this.parent_business;
               var2.mapRecord(PeopleEditorBusiness.this.record);
               var2.refreshView();
               var2.restorePanel();
   ...
   private boolean isContentValid() {
      String var1 = this.txt_first_name.getText() + " " + this.txt_last_name.getText();
      String var2 = this.filterForNumbers(this.txt_tax_id.getText());
      var1 = var1.trim();
      var2 = var2.trim();
      if (var1.length() != 0 && var2.length() != 0) {
         if (!this.isValidTaxId()) {
            GuiUtil.showMessageDialog(this.p_editor_panel, "Az adóazonosító jel hibás !", "Törzsadat ellenőrzés", 2);
            return false;
         } else {
            IRecord[] var3;
            if ((var3 = this.record.filterOnAll("tax_id", this.filterForNumbers(this.txt_tax_id.getText()))).length > 0) {
               IRecord var4 = this.getFirstDifferent(var3, this.record);
               if (var4 != null) {
                  GuiUtil.showMessageDialog(this.p_editor_panel, "Adóazonosító már használva van itt: '" + var4 + "' !", "Törzsadat ellenőrzés", 2);
                  return false;
               }
            }
         ...
         GuiUtil.showMessageDialog(this.p_editor_panel, "Vezetéknév, Keresztnév és Adóazonosító jel mezőket kötelező kitölteni !", "Törzsadat ellenőrzés", 2);
         return false;
      }
   }
   ...
   private boolean isValidTaxId() {
      ...
      String var2 = this.txt_tax_id.getText();
      String var3 = this.filterForNumbers(var2);
      if (var2.trim().length() > 0 && var3.trim().length() == 0) {
         return false;
      } else {
         Object var4 = var1.calculateExpression("[jóadóazonosító,\"" + this.filterForNumbers(var2) + "\"]");
         if (var4 == null) {
            return false;
         } else {
   ...
   private void prepareCancel() {
      ...
      this.btn_cancel.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent var1) {
            PeopleEditorBusiness.this.parent_business.restorePanel();
         }
      });
   }
   ...
   private void installKeyBindingForButton(final JButton var1, int var2) {
      ...
      PeopleEditorPanel var4 = this.p_editor_panel;
   ...
   private void setFormatter(JFormattedTextField var1, String var2) {
      try {
         MaskFormatter var3 = new MaskFormatter(var2);
         var3.setPlaceholderCharacter('_');
         var1.setFormatterFactory(new DefaultFormatterFactory(var3));
         var3.install(var1);
   ...
   private void showRecord() {
      if (this.record != null) {
         ...
         this.txt_first_name.setText((String)var1.get("first_name"));
         this.txt_last_name.setText((String)var1.get("last_name"));
         this.txt_tax_id.setText((String)var1.get("tax_id"));
   ...
   private void modifyRecord() {
      if (this.record != null) {
         Hashtable var1 = this.record.getData();
         var1.put("name", this.txt_first_name.getText() + " " + this.txt_last_name.getText());
         var1.put("first_name", this.txt_first_name.getText());
         var1.put("last_name", this.txt_last_name.getText());
         var1.put("tax_id", this.filterForNumbers(this.txt_tax_id.getText()));

...
public class OtherUnixOsHandler extends DefaultUnixOsHandler {
   ...
   public void createItem(ILinuxDesktopHandler var1, File var2, String var3, String var4, String var5, String var6, String var7, String var8, String var9) {
      if (var2 != null) {
         ...
         File var11 = new NecroFile(var8 + "/abevjava.app/Contents");
         File var12 = new NecroFile(var8 + "/abevjava.app/Contents/Resources");
         File var13 = new NecroFile(var2 + "/abevjava.app/Contents/Resources");
         File var14 = new NecroFile(var2 + "/abevjava.app/Contents");
         File var15 = new NecroFile(var2 + "/abevjava.app/Contents/MacOS");
         if (!var15.exists()) {
            var15.mkdirs();
         }
         ...
         try {
            ...
            File var16 = new NecroFile(var15 + File.separator + "abevjava");
